<?php
///////////////////activation link for Motilal Oswal
include "config.php";
if(isset($_POST[activate4_submit]))
{
    ...
    if($df[activate_link1]!='y')
    {
        ...
        mysql_query("INSERT INTO `ibo_activate_link_history` (`ialh_id`, `ibo_id`, `activate_link_no`, `activate_link_name`, `date`) VALUES (NULL, '$_POST[d_id]', '4', 'Motilal Oswal', '$date');")or die("its failed to register activate link please contact proagramer and dont try it again");
...
$date=date("Y-m-d");
    $amount=0;
    ///////////////////level 0 amount 50
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$d_id', '$date', '$time', '50', '+', '0', 'own Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv0");
    $d=mysql_query("SELECT s_id,hold_wallet FROM `ibo` WHERE `ibo_id`='$d_id'")or die("sorry query fail lv0.1");
    $s=mysql_fetch_assoc($d);
    $c=mysql_num_rows($d);
    $amount=$s[hold_wallet]+50;
    ...
    {
    ///////////////////level 1 amount 200
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$s[s_id]', '$date', '$time', '200', '+', '1', 'LV1 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv1");
    
    $df=mysql_query("SELECT s_id,hold_wallet FROM `ibo` WHERE `ibo_id`='$s[s_id]'")or die("sorry query fail lv1.1");
    $sf=mysql_fetch_assoc($df);
    $amount=$sf[hold_wallet]+200;
    ...
    {
    //////////////////level 2 amount 40
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sf[s_id]', '$date', '$time', '40', '+', '2', 'LV2 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv2");
    ...
    {
    //////////////////level 3 amount 20
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sff[s_id]', '$date', '$time', '20', '+', '3', 'LV3 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv3");
    ...
    {
    /////////////////level 4 amonut 10
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sfffe[s_id]', '$date', '$time', '10', '+', '4', 'LV4 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv4");
    ...
    {
    //////////////////level 5 amount 5
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sfff[s_id]', '$date', '$time', '5', '+', '5', 'LV5 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv5");
    ...
    {
    ///////////////// level 6 amount 4
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sffff[s_id]', '$date', '$time', '4', '+', '6', 'LV6 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv6");
    ...
    {
    ///////////////// level 7 amount 3
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sfffff[s_id]', '$date', '$time', '3', '+', '7', 'LV7 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv7");
    ...
    {
    //////////////// level 8 amount 5
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sffffff[s_id]', '$date', '$time', '5', '+', '8', 'LV8 Commission by Motilal Oswal', '$d_id');")or die("sorry query fail lv8");
    $dfffffff=mysql_query("SELECT s_id,hold_wallet FROM `ibo` WHERE `ibo_id`='$sffffff[s_id]'");
    $sfffffff=mysql_fetch_assoc($dfffffff);
    $amount=$sfffffff[hold_wallet]+5;
