<?php
///////////////////activation link for Upstox
include "config.php";
if(isset($_POST[activate2_submit]))
{
    ...
    if($df[activate_link1]!='y')
    {
        ...
        mysql_query("INSERT INTO `ibo_activate_link_history` (`ialh_id`, `ibo_id`, `activate_link_no`, `activate_link_name`, `date`) VALUES (NULL, '$_POST[d_id]', '2', 'Upstox', '$date');")or die("its failed to register activate link please contact proagramer and dont try it again");
...
$date=date("Y-m-d");
    $amount=0;
    ///////////////////level 0 amount 40
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$d_id', '$date', '$time', '40', '+', '0', 'own Commission by Upstox', '$d_id');")or die("sorry query fail lv0");
    ...
    {
    ///////////////////level 1 amount 100
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$s[s_id]', '$date', '$time', '100', '+', '1', 'LV1 Commission by Upstox', '$d_id');")or die("sorry query fail lv1");
    ...
    {
    //////////////////level 2 amount 30
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sf[s_id]', '$date', '$time', '30', '+', '2', 'LV2 Commission by Upstox', '$d_id');")or die("sorry query fail lv2");
    ...
    {
    //////////////////level 3 amount 20
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sff[s_id]', '$date', '$time', '20', '+', '3', 'LV3 Commission by Upstox', '$d_id');")or die("sorry query fail lv3");
    ...
    {
    /////////////////level 4 amonut 10
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sfffe[s_id]', '$date', '$time', '10', '+', '4', 'LV4 Commission by Upstox', '$d_id');")or die("sorry query fail lv4");
    ...
    {
    //////////////////level 5 amount 5
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sfff[s_id]', '$date', '$time', '5', '+', '5', 'LV5 Commission by Upstox', '$d_id');")or die("sorry query fail lv5");
    ...
    {
    ///////////////// level 6 amount 3
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sffff[s_id]', '$date', '$time', '3', '+', '6', 'LV6 Commission by Upstox', '$d_id');")or die("sorry query fail lv6");
    ...
    {
    ///////////////// level 7 amount 2
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sfffff[s_id]', '$date', '$time', '2', '+', '7', 'LV7 Commission by Upstox', '$d_id');")or die("sorry query fail lv7");
    ...
    {
    //////////////// level 8 amount 1
    mysql_query("INSERT INTO `hold_wallet_history` (`hwh_id`, `ibo_id`, `date`, `time`, `amount`, `type`, `broker_level`, `history_note`, `f_ibo_id`) VALUES (NULL, '$sffffff[s_id]', '$date', '$time', '1', '+', '8', 'LV8 Commission by Upstox', '$d_id');")or die("sorry query fail lv8");
