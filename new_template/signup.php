					...
					<form action="post">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="dob" class="form-control" placeholder="Your D.O.B">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
...
<option value="West Bengal">West Bengal</option>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="number" name="r_id" class="form-control" placeholder="id">
							</div>
						</div>
						<?php
                            $dff=mysql_query("SELECT * FROM `ibo` WHERE `ibo_id`=$_GET[r_id]");
