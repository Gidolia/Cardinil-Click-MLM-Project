<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              ...
              <a href="index.php" class="site_title">&nbsp;&nbsp;<img src="../../blackwhite_transperant-01.png" height="50" width="140" alt="Cardinil"></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-sitemap"></i> My Network<span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a href="plan.php"><i class="fa fa-money"></i> Plan</a></li>
                   <li><a><i class="fa fa-bank"></i>Banking<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="acc_balance.php">Account</a></li>
                        <li><a href="hold_wallet.php">Hold Wallet</a></li>
